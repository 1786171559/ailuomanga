        ...
        <form class="layui-form">
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="hidden" id="L_resId" name="resId" value="${resource.resId}">
                    <input type="text" id="L_resName" name="resName" lay-verify="resNames"
                           class="layui-input" value="${resource.resName}" autocomplete="off" required=""></div>
            </div>
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="L_resUrl" name="resUrl" lay-verify="resUrls"
                           class="layui-input" value="${resource.resUrl}" autocomplete="off" required=""></div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline" style="height: 38px">
                    <c:choose>
                        <c:when test="${resource.isEnable=='1'}">
            ...
            <div class="layui-form-item">
                <label for="L_resUrl" class="layui-form-label"></label>
...
<script>
    layui.use(['form', 'layer'], function () {
        ...
        form.on('submit(editBtn)', function (data) {
            ...
            $.ajax({
                // 编写json格式，设置属性和值
                url: "${pageContext.request.contextPath}/admin/changeResource",
                data: {
                    "resId": resource.resId,
                    "resName": resource.resName.trim(),
                    "resUrl":resource.resUrl.trim(),
                    "isEnable":resource.isEnable
                },
                async: false,
                dataType: "json",
                type: "post",
