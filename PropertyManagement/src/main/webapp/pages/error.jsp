...
<head>
    ...
    <style type="text/css">
        ...
        .m-maintenance-footer-wrapper .copyright, .m-maintenance-footer-wrapper .policy-info {
            margin-bottom: 10px
        }
    </style>
    <style type="text/css">
        ...
        .m-maintenance-background-image {
            ...
            background-image: url("${pageContext.request.contextPath}/images/Hd22375a6362246758643ef4e7150202cy.jpg")
        }
