...
<script>
    layui.use('table', function () {
        ...
        table.render({
            ...
            , url: '${pageContext.request.contextPath}/intelligenceService/peopleGetComplaintInfo?v=' + new Date().getTime()//数据接口
            , cols: [[
                //表头
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            if (data.flag == "success") {
                                window.location.href = "${pageContext.request.contextPath}/intelligenceService/doComplaint"
                            } else {
