...
<script>
    layui.use(['table','rate'], function () {
        ...
        table.render({
            ...
            , url: '${pageContext.request.contextPath}/maintain/getMainInfo?v=' + new Date().getTime()//数据接口
            , cols: [[
                //表头
        ...
        table.on('tool(demo)', function (obj) {
            ...
            if (obj.event === 'del') {
                ...
                parent.layer.open({
                    ...
                    maxmin: true,
                    closeBtn: 1,
                    content: ['${pageContext.request.contextPath}/maintain/getOneMaintainById/' + data.maintainId, 'yes'], //iframe的url，yes是否有滚动条
                    end: function () {
                        location.reload();
                    }
                })
            } else if (obj.event === 'repairPeson') {
                //iframe层
                parent.layer.open({
                    type: 2,
                    title: '修改',
                    ...
                    maxmin: true,
                    closeBtn: 1,
                    content: ['${pageContext.request.contextPath}/maintain/returnJspToDisPatchPerson/' + data.maintainId, 'yes'], //iframe的url，yes是否有滚动条
                    end: function () {
                        location.reload();
                    }
                })
