    ...
    <div class="layui-row">
        <form class="layui-form">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="L_loginName" name="loginName" lay-verify="loginNames"
                           class="layui-input" value="" autocomplete="off" required=""></div>
            </div>
            <div class="layui-form-item">
        ...
        form.on('submit(editBtn)', function (data) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    } else if (data.flag == "phoneIsExit") {
                        alert("手机号已注册，请重新填写");
                    } else if (data.flag == "loginNameIsExit") {
                        alert("账户已注册，请重新填写");
                    } else {
                        alert("新增失败，后端异常")
                    }
