...
<div class="error_new_bg pr">
    <div class="error_new_content">
        <div class="error_new pa">
            <div class="fl error_new_left"><img src="${pageContext.request.contextPath}/images/error-1.png"></div>
            <div class="fl error_new_right">
                <p class="mb15"><img src="${pageContext.request.contextPath}/images/error-2.png"></p>
            </div>
        </div>
    </div>
</div>
